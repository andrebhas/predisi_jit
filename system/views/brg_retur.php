        ...
        <div class="box">
            ...
            <div class="box-content">
                <div class="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="ket" class="form-control span3">
                ...
                <div class="table-responsive">
                    <form action="<?= base_url() ?>simpan/retur" role="form" method="post" onsubmit="return confirm('Pastikan data benar?')">
                        <div class="box-title">
                            <h4><i class="icon-file-text"></i> Data Barang Retur</h4>
                        </div>
                        <div class="span12">
                            <div class="span4">
                                <div class="control-group">
